...
├── assortment.html      — ассортимент ([ИМЯ СТУДЕНТА 1])
├── order.html            — форма заказа ([ИМЯ СТУДЕНТА 1])
├── brands.html           — бренды и поставщики ([ИМЯ СТУДЕНТА 2])
├── delivery.html         — доставка и оплата, форма ([ИМЯ СТУДЕНТА 2])
├── reviews.html          — отзывы покупателей ([ИМЯ СТУДЕНТА 3])
├── contacts.html         — контакты, форма записи на примерку ([ИМЯ СТУДЕНТА 3])
...
| Студент | Страницы |
|---|---|
| [ИМЯ СТУДЕНТА 1] | assortment.html, order.html |
| [ИМЯ СТУДЕНТА 2] | brands.html, delivery.html |
| [ИМЯ СТУДЕНТА 3] | reviews.html, contacts.html |
